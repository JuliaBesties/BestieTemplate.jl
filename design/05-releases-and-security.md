...
- **Dependency posture**: L1 is stdlib + `pyyaml`; frontends add typer / fastapi / fastmcp behind optional dependency groups so the core install stays small. copier is pinned `>=9.14,<10` with a CI canary against latest.
