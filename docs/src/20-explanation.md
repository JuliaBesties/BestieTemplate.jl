...
- It is a strong recommendation that we think you should adopt (e.g., `pre-commit`).
- It is a common practice, file, or tool _in general_ (e.g., .).
...
Finally, there are **other optional features** that are neither recommended nor part of any strategy.
